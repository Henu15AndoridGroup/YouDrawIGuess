...
import me.cizezsy.yourdrawiguess.adapter.GuideViewPagerAdapter;
...
public class WelcomeGuideActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new GuideViewPagerAdapter(mViewList);
	...
	protected void onPause() {
		super.onPause();
		SpUtils.putBoolean(WelcomeGuideActivity.this, MyApplication.IS_FIRST_OPEN, true);
		finish();
	}
